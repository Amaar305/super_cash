...
class AirtimeShareAndSellPage extends StatelessWidget {
  const AirtimeShareAndSellPage({super.key});
          ...
          AuthContainer(
            child: Column(
              children: [
                ...
                PrimaryButton(
                  label: 'Use VTU Airtime',
                  onPressed: () =>
                      context.read<AirtimeCubit>().onToggleShowPassword(true),
                ),
              ],
            ),
          ),

...
class FundCardCoolDownText extends StatelessWidget {
  const FundCardCoolDownText({
    super.key,
  });
      ...
      children: [
        ...
        BlocBuilder<CooldownCubit, CooldownState>(
          builder: (context, state) {
            ...
            final remaining = cooldowns[CooldownKeys.fundCard];
            var style = TextStyle(

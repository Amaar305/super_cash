...
class DirectAirtimeGiveawayClaimPhoneField extends StatefulWidget {
  ...
  @override
  State<DirectAirtimeGiveawayClaimPhoneField> createState() =>
      _DirectAirtimeGiveawayClaimPhoneFieldState();
}

class _DirectAirtimeGiveawayClaimPhoneFieldState
    extends State<DirectAirtimeGiveawayClaimPhoneField> {
  late final DirectAirtimeGiveawayCubit _cubit;
  ...
  void initState() {
    super.initState();
    _cubit = context.read<DirectAirtimeGiveawayCubit>();
  ...
  Widget build(BuildContext context) {
    ...
    final phoneErrMsg = context.select(
      (DirectAirtimeGiveawayCubit cubit) => cubit.state.phone.errorMessage,
    );
    return Column(
